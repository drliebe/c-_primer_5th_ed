...
{
	std::vector<Quote> vq;
	vq.push_back(Bulk_quote("123", 9.99, 10, 0.25));
	vq.push_back(Bulk_quote("456", 12.99, 10, 0.25));
	vq.push_back(Bulk_quote("789", 14.99, 10, 0.25));
	vq.push_back(Bulk_quote("975", 19.99, 10, 0.25));
